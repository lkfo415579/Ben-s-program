...
def parseTreeBerkeley(inputName, language, outputName):	
	...
	if language == 'en':
		cmd = 'java -Dfile.encoding=UTF-8 -jar '+parser+' -gr '+path+'eng_sm6.gr < '+inputName+' > '+outputName+'.tmp'
	elif language == 'cn':
		cmd = 'java -Dfile.encoding=UTF-8 -jar '+parser+' -gr '+path+'chn_sm5.gr < '+inputName+' > '+outputName+'.tmp'
	elif language == 'de':
		cmd = 'java -Dfile.encoding=UTF-8 -jar '+parser+' -gr '+path+'ger_sm5.gr < '+inputName+' > '+outputName+'.tmp'
	elif language == 'fr':
		cmd = 'java -Dfile.encoding=UTF-8 -jar '+parser+' -gr '+path+'fra_sm5.gr < '+inputName+' > '+outputName+'.tmp'
	else:
