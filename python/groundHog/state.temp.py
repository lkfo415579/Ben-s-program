def prototype_state():
    ...
    state['loopIters'] = 500000
    # Maximum number of minutes to run
    state['timeStop'] = 60*24*7
...
def prototype_phrase_state():
    ...
    state['source'] = ["./data/train/train.source.h5"]
    state['target'] = ["./data/train/train.target.h5"]
    state['indx_word'] = "./data/train/train.source.idword.pkl"
    state['indx_word_target'] = "./data/train/train.target.idword.pkl"
    state['word_indx'] = "./data/train/train.source.wordid.pkl"
    state['word_indx_trgt'] = "./data/train.train.target.wordid.pkl"
...
def prototype_encdec_state():
    ...
    state['target'] = ["./data/train/binarized_text.shuffled.target.h5"]
    state['source'] = ["./data/train/binarized_text.shuffled.source.h5"]
    state['indx_word'] = "./data/train/train.source.idword.pkl"
    state['indx_word_target'] = "./data/train/train.target.idword.pkl"
    state['word_indx'] = "./data/train/train.source.wordid.pkl"
    state['word_indx_trgt'] = "./data/train/train.target.wordid.pkl"
...
#    state['null_sym_target'] = 30000
    state['null_sym_source'] = 80000
    state['null_sym_target'] = 80000
    state['n_sym_source'] = state['null_sym_source'] + 1
    state['n_sym_target'] = state['null_sym_target'] + 1
...
#    state['seqlen'] = 30
    ...
    state['prefix'] = 'encdec_v80k_seq80_'
