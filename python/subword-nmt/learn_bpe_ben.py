...
def update_pair_statistics(pair, changed, stats, indices):
	...
	#print 'new_pair', new_pair, changed
...
def ben_get_pair_statistics(vocab):
	"""Count frequency of all symbol pairs, and create index"""
	...
	for i, (word, freq) in enumerate(vocab):
		newword = tuple(''.join(list(word)).split('@@'))
		#print i, word, freq, newword
...
if __name__ == '__main__':
	...
	reformat_sorted_vocab = []
	stats, indices = ben_get_pair_statistics(sorted_vocab)
	for w, c in sorted_vocab:
		reformat_sorted_vocab.append((tuple(''.join(w).split('@@')), c))
	sorted_vocab = reformat_sorted_vocab
	...
	for i in range(args.symbols):
		...
		#print 'stats=',stats, 'indices=',indices,'sorted_vocab=',sorted_vocab
